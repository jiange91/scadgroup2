...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-7-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-7']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-7-pool'] = selfPool
