...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-9-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-9']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-9-pool'] = selfPool
