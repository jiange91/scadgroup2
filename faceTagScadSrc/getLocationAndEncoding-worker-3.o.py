...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-3-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-3']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-3-pool'] = selfPool
