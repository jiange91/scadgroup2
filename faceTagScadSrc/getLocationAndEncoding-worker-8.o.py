...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-8-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-8']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-8-pool'] = selfPool
