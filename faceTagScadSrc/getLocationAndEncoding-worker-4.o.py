...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-4-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-4']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-4-pool'] = selfPool
