...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-5-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-5']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-5-pool'] = selfPool
