...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-6-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-6']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-6-pool'] = selfPool
