...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-2-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-2']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-2-pool'] = selfPool
