...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='tagNameOnFrames-worker-0-mem', memSize=
    ...
    stkTargets = context_dict['tagNameOnFrames-worker-0']
    ...
    context_dict = {}
    context_dict['tagNameOnFrames-worker-0-pool'] = selfPool
