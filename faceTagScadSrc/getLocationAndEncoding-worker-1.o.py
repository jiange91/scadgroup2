...
def main(params, action):
    ...
    localPool = {}
    selfPool = ObjPool(name='getLocationAndEncoding-worker-1-mem', memSize=
    ...
    stkTargets = context_dict['getLocationAndEncoding-worker-1']
    ...
    context_dict = {}
    context_dict['getLocationAndEncoding-worker-1-pool'] = selfPool
